<!-- resources/views/components/historial-apartados-table.blade.php -->
    ...
    <table class="min-w-full bg-white border border-gray-200 shadow-sm rounded-lg">
        <thead>
            <tr class="bg-gradient-to-r from-blue-50 to-indigo-50">
                ...
                <th class="px-6 py-4 border-b border-gray-300 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">
                    <div class="flex items-center">
                        <ion-icon name="folder-outline" class="text-base text-purple-500 mr-2"></ion-icon>
                        Apartado
                    </div>
                </th>
                <th class="px-6 py-4 border-b border-gray-300 text-left text-sm font-semibold text-gray-700 uppercase tracking-wider">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-sm text-gray-400">No se encontraron modificaciones en los apartados del checklist</p>
                        </div>
                    </td>
                </tr>
            @endforelse
