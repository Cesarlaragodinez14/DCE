<div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 space-y-4">
    <x-ui.breadcrumbs>
        ...
        <x-ui.breadcrumbs.link active
            >Editar: {{ __('crud.catEntregas.itemTitle') }}</x-ui.breadcrumbs.link
        >
    </x-ui.breadcrumbs>

    <x-ui.toast on="saved"> CatEntrega saved successfully. </x-ui.toast>

    <div class="w-full text-gray-500 text-lg font-semibold py-4 uppercase">
        <h1>Editar: {{ __('crud.catEntregas.itemTitle') }}</h1>
    </div>
            ...
            <div class="p-6 space-y-3">
                <div class="w-full">
                    ...
                    <x-ui.input.text
                        ...
                        name="valor"
                        id="valor"
                        placeholder="{{ __('crud.catEntregas.inputs.valor.placeholder') }}"
                    />
                ...
                <div class="w-full">
                    ...
                    <x-ui.input.textarea
                        ...
                        name="descripcion"
                        id="descripcion"
                        placeholder="{{ __('crud.catEntregas.inputs.descripcion.placeholder') }}"
                    />
    ...
    <div class="overflow-hidden border rounded-lg bg-white">
        <div class="w-full mb-0">
            <div class="p-6 space-y-3">
                ...
                <livewire:dashboard.cat-entrega-all-auditorias-detail
                    :cat-entrega="$catEntrega"
                />
            </div>
        </div>
    </div>
